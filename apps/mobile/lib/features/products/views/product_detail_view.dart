...
class ProductDetailView extends StatelessWidget {
              ...
              child: ClipRRect(
                ...
                child: imageUrl.isNotEmpty && imageUrl.startsWith('http')
                    ? CachedNetworkImage(
                        ...
                        errorWidget: (_, __, ___) => Icon(Icons.inventory_2_rounded, size: Responsive.icon(40), color: Colors.grey[300]),
                      )
              ...
              children: [
                if (product.sku != null && product.sku!.isNotEmpty)
                  Container(
                    ...
                    child: Text('SKU: ${product.sku}', style: TextStyle(fontSize: Responsive.sp(10), fontFamily: 'monospace', fontWeight: FontWeight.bold)),
                  ),
                const Spacer(),
                Text(
                  '₹${product.pricePerDay.toStringAsFixed(0)} / day',
                  style: TextStyle(fontSize: Responsive.sp(16), fontWeight: FontWeight.w800, color: const Color(0xFFF7C873)),
                ),
              ],
            ),
            if (product.description != null && product.description!.isNotEmpty) ...[
              SizedBox(height: Responsive.h(10)),
              Text(product.description!, style: TextStyle(fontSize: Responsive.sp(12), color: Colors.grey[700], height: 1.5)),
            ],
            SizedBox(height: Responsive.h(16)),
  ...
  Widget _buildSectionTitle(String title) {
    return Padding(
      ...
      child: Text(title, style: TextStyle(fontSize: Responsive.sp(14), fontWeight: FontWeight.bold, color: _primary)),
    );
  }
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(color: Colors.white, shape: BoxShape.circle, boxShadow: [BoxShadow(color: stockColor.withValues(alpha: 0.15), blurRadius: Responsive.r(6), offset: Offset(0, Responsive.h(2)))]),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(stockText, style: TextStyle(fontSize: Responsive.sp(14), fontWeight: FontWeight.bold, color: stockColor)),
                SizedBox(height: Responsive.h(2)),
                Text('${product.availableQuantity} items available', style: TextStyle(fontSize: Responsive.sp(11), color: Colors.black87)),
              ],
            ),
          ),
        ],
  ...
  Widget _buildDetailRow(String label, String value) {
    return Row(
      ...
      children: [
        Flexible(child: Text(label, style: TextStyle(fontSize: Responsive.sp(12), color: Colors.grey[600]))),
        Text(value, style: TextStyle(fontSize: Responsive.sp(12), fontWeight: FontWeight.bold, color: _primary)),
      ],
    );
  }
}
