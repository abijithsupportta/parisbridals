          ...
          _buildToggleSection(
            ...
            expandedChild: Column(
              ...
              children: [
                SizedBox(height: Responsive.h(12)),
                _buildAmountField(
                  (v) => onSecurityDepositChanged(double.tryParse(v) ?? 0),
                ),
                SizedBox(height: Responsive.h(12)),
                _buildMethodLabel(),
          ...
          _buildToggleSection(
            ...
            expandedChild: Column(
              ...
              children: [
                SizedBox(height: Responsive.h(12)),
                _buildAmountField(
                  (v) => onAdvanceChanged(double.tryParse(v) ?? 0),
                ),
                SizedBox(height: Responsive.h(12)),
                _buildMethodLabel(),
                SizedBox(height: Responsive.h(8)),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Review totals and collect payment',
                  style: TextStyle(
          ...
          Row(
            children: [
              Icon(
                ...
                color: isOn ? _primary : Colors.grey[400],
              ),
    ...
    return Row(
      ...
      children: [
        ...
        Text(
          value,
          style: TextStyle(
            fontSize: Responsive.sp(isBold ? 16 : 13),
      ...
      child: Column(
        children: [
          ...
          if (collectDeposit && securityDeposit > 0) ...[
            ...
            _summaryRowWhite(
              'Security Deposit',
              '₹${effectiveDeposit.toStringAsFixed(0)}',
            ),
          ],
          ...
          if (collectAdvance && advanceAmount > 0) ...[
            ...
            _summaryRowWhite(
              'Advance Paid',
              '- ₹${effectiveAdvance.toStringAsFixed(0)}',
